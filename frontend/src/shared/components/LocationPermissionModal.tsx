...
const FeatureRow: React.FC<FeatureRowProps> = memo(({ icon, iconBg, iconColor, title, subtitle, delay, index }) => {
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        <Text style={{ fontSize: 17, fontWeight: '600', color: '#1C1C1E', marginBottom: 2 }}>
          {title}
        </Text>
        <Text style={{ fontSize: 15, color: '#8E8E93', lineHeight: 20 }}>
          {subtitle}
        </Text>
      </View>
    </Animated.View>
      ...
      <Animated.View style={{ transform: [{ scale: pressScale }] }}>
        ...
        >
          ...
          >
            ...
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFF', letterSpacing: 0.3 }}>
              Enable Location
            </Text>
          </LinearGradient>
        </TouchableOpacity>
