  ...
  return (
    <View style={[styles.idFrame, { width: ID_FRAME_WIDTH, height: ID_FRAME_HEIGHT }]}>
      ...
      <View style={styles.idFrameCenter}>
        ...
        <Text style={styles.idFrameHint} maxFontSizeMultiplier={FONT_SCALING.BODY}>Position ID here</Text>
      </View>
    </View>
  );
};
...
export const CaptureButton: React.FC<CaptureButtonProps> = ({
  ...
  <View style={styles.captureSection}>
    ...
    <Text style={styles.captureHint} maxFontSizeMultiplier={FONT_SCALING.BODY}>Tap to capture</Text>
  </View>
);
