...
export const IDVerificationScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  // Auth store
  const verifyIdStore = useAuthStore((state) => state.verifyId);
  ...
  const handleVerify = useCallback(async () => {
    ...
    try {
      ...
      // Call auth store verifyId
      await verifyIdStore(frontBlob, backBlob);
      ...
      Alert.alert(
        ...
        'Your ID has been verified! Welcome to TANDER - your journey to meaningful connections begins now.',
        [
          {
            text: 'Start Matching',
            onPress: () => {
  ...
  }, [frontPhoto, backPhoto, verifyIdStore, navigation]);
