          ...
          >
            ...
            <View style={[styles.mainContent, { maxWidth: sizes.maxWidth }]}>
              ...
              <Animated.View style={[styles.logoSection, { opacity: logoAnim, transform: [{ scale: logoScale }] }]}>
                ...
                <Text style={[styles.heroTitle, { fontSize: sizes.title }]}>Welcome Back</Text>
                <Text style={[styles.heroSubtitle, { fontSize: sizes.subtitle }]}>Sign in to continue your journey</Text>
              </Animated.View>
                ...
                {error && (
                  <View style={styles.errorBanner}>
                    ...
                    <View style={styles.errorTextContainer}>
                      ...
                      <Text style={styles.errorBannerMsg}>{error}</Text>
                    </View>
                  </View>
                )}
                        ...
                        {biometricAuthenticating ? (
                          ...
                          <>
                            <Ionicons
                              ...
                              color="#FFFFFF"
                            />
                            <Text style={styles.biometricText}>Continue with {biometricLabel}</Text>
                          </>
                        )}
                      </LinearGradient>
                    </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  biometricGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
  ...
  signInGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
